...
//    @PostMapping("/userId/{userId}/name/{name}")
//    public UserResponse exchangeHeader(@RequestBody UserRequest user,@PathVariable long userId, @PathVariable  String name){
//        return restTemplateService.exchangeHeader(user,userId,name);
//    }
    @PostMapping("/userId/{userId}/name/{name}")
